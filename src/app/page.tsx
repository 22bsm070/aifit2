      ...
      <section className="relative z-10 py-24 flex-grow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
             ...
             {/*separator line*/}
             <div className="h-px w-full bg-gradient-to-r from-primary via secondarry to-primary opacity-50"></div>   
                <p className="text-xl  w-2/3 text-black">
                ...
                {/*button*/}
                <div className="flex flex-dol sm:flex-row gap-4 pt-6">
                    <Button
                    size="lg"
                    asChild
